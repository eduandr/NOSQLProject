...
public class ViewPagerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imgUrl = new String[1];// OJO
        if (getIntent() != null) {
            position = getIntent().getIntExtra("position", 0);
            imgUrl[0]= getIntent().getStringExtra("img");
            mViewPager.setCurrentItem(position);
        }
        mViewPager.setAdapter(new SamplePagerAdapter(imgUrl));
    ...
    static class SamplePagerAdapter extends PagerAdapter {
       /* Here I'm adding the demo pics, but you can add your Item related pics , just get your pics based on itemID (use asynctask) and
        ...
        SamplePagerAdapter(String[] imgUrl)
        {
              sDrawables = imgUrl;
        }
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            Log.i("PHOTO",sDrawables[position]);
