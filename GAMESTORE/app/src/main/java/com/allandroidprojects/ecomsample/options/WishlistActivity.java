...
public class WishlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Product> wishlistImageUri =imageUrlUtils.getWishlistImageUri();
...
//                ((BitmapDrawable) holder.mImageView.getTopLevelDrawable()).getBitmap().recycle();
        ...
        public void onBindViewHolder(final WishlistActivity.SimpleStringRecyclerViewAdapter.ViewHolder holder, final int position) {
            final Uri uri = Uri.parse(mWishlistImageUri.get(position).getImg());
            holder.mImageView.setImageURI(uri);
            holder.item_name.setText(mWishlistImageUri.get(position).getName());
            holder.item_desc.setText(mWishlistImageUri.get(position).getDesc());
            holder.item_price.setText(mWishlistImageUri.get(position).getPrice());
            holder.mLayoutItem.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, ItemDetailsActivity.class);
                    intent.putExtra(STRING_IMAGE_URI,mWishlistImageUri.get(position).getImg());
